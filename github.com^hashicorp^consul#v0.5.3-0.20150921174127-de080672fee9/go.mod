module github.com/hashicorp/consul-v0.5.3-0.20150921174127-de080672fee9

go 1.17

require github.com/hashicorp/consul v0.5.3-0.20150921174127-de080672fee9
...
require (
	...
	github.com/hashicorp/consul-migrate v0.1.0 // indirect
