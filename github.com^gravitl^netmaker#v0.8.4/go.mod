module github.com/gravitl/netmaker-v0.8.4

go 1.17

require github.com/gravitl/netmaker v0.8.4
...
require (
	...
	golang.zx2c4.com/wireguard/wgctrl v0.0.0-20210913210325-91d1988e44de // indirect
