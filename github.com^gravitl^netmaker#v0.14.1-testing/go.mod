module github.com/gravitl/netmaker-v0.14.1-testing

go 1.17

require github.com/gravitl/netmaker v0.14.1-testing
...
require (
	...
	github.com/seancfoley/ipaddress-go v1.1.2 // indirect
